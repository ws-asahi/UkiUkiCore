...
|------|------|------|------|------|
| Tsurugi | AVR64DU32 | 24.0 | (未検証)  | (未検証) |
| Arduino Uno R3 | ATmega328P | 16.0 | 17307.590 | -(書き込み不可) |
| Arduino Leonardo | ATmega32U4 | 16.0 | 17207.268 | -(動作せず) |
| Arduino Uno R4 | RA4M1 | 48.0 | 62303.986 | 81.78 |
