/* ============================================================
 * PWMTest - コア開発者向けのPWMセルフテスト
 *
 * initTCx()/analogWrite()/turnOffPWM()が正しいピンへ正しい周波数で
 * PWMを出しているかを実機で検証する、コア保守用のテストスケッチです。
 * 一般の利用者向けサンプルではないため、以下の本文コメントは
 * 原文(英語)のまま保持しています。
 * ============================================================ */
/******************************************************************************
 ...
 * available - e.g. the crystal pins on Tsurugi, or the on-board LED pins
 * PA0/PA1 on Tachi).
 *
