...
commit f3a8369). It contains AVR DU-series support that has been
submitted upstream as NicoHood/HID#472 (not merged at bundling time).
Original work (C) 2014-2021 NicoHood and contributors, MIT license (see
LICENSE). Modifications (C) 2026 Yusuke Shimizu - Workshop Asahi.
